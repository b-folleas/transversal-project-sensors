...
def radio_send(msg): # function that split the msg into packets (packetArray and send them through radio)
    packet_id = 0
    flag = 'PSH'
    for i in range(0, len(msg)-1, 22):
        ...
        while len(subMsg) < 22 :
            subMsg+='#' # padding
            flag = 'FIN'
        # j'espere que mon ternaire ne va pas foirer, si ça marche -> modifier init_connection
